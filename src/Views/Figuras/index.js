    ...
    render () {
        return (
            <section className={styles.__page}>
                ...
                <Sinopsis
                    title="Mario Agustín"
                    sinopsis="El artesano Mario Agustín y su familia trabajan 3 técnicas artesanales de gran herencia histórica para la cultura Purépecha. Desde íconos religiosos hechos de pasta de caña, hasta grandes platos decorados con oro, técnicas que se dice fueron enseñadas por Don Vasco de Quiroga o fusionadas con las que ya dominaban los indígenas de la región lacustre de Michoacán a finales del Siglo XV."
                    buttonClick={this.hideSinopsis}/>
                <VimeoPlayer 
                    videoId= 'mascaras'
                    videoTitle= 'Alfarería'
                    videoURL= 'https://player.vimeo.com/video/314845532?background=1&autoplay=1&loop=0&byline=0&title=0&muted=0'
                    muted= '1'/>
            </section>
        )
    }
