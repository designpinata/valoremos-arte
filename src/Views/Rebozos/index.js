...
class Rebozos extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <section className={styles.__page}>
                ...
                <VideoControls 
                    ...
                    />
                <Sinopsis
                    title="Rebozos de Plumas de Aves"
                    sinopsis="K’uaníndikua” es el documental en el que se narra la historia de Albertina Bautista y su familia, pionera en crear rebozos con detalles de pluma de distintas aves. El rebozo es parte de las tradiciones más antiguas de México y podrás conocer el maravilloso trabajo de la artesana michoacana, perteneciente de Ahuirán Michoacán, en el que mantiene con orgullo las tradiciones y además, las comparte con futuras generaciones para mantenerlas vivas."
                    buttonClick={this.hideSinopsis}/>
                <VimeoPlayer 
                    videoId= 'mascaras'
                    videoTitle= 'Rebozos de Plumas de Aves'
                    videoURL= 'https://player.vimeo.com/video/306934430?background=1&autoplay=1&loop=0&byline=0&title=0&muted=0'
                    muted= '1'/>
            </section>
        )
    }
